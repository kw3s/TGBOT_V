    ...
    if ((msg.reply_to_message && msg.reply_to_message.from.is_bot) || cachedImageId) {
        ...
        if (msg.audio) {
            ...
            if (imageFileId) {
                ...
                await bot.sendMessage(chatId, "Processing your media... ⏳\n1. Downloading files...");
                ...
                try {
                    ...
                    const processingMsg = await bot.sendMessage(chatId, "Merging files... 🎬");
                    ...
                    // 4. Send Video
                    await bot.sendMessage(chatId, "3. Uploading video... 🚀");
